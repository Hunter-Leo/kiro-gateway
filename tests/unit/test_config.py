...
class TestServerPortConfig:
    ...
    def test_default_server_port_is_8000(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            import importlib
            import kiro.config as config_module
            # The reload re-runs load_dotenv(), which would otherwise pull
            # SERVER_PORT out of the developer's ~/.config/kiro-gateway/.env.
            # Neutralise it so the built-in default is what gets asserted.
